...
#         bot = Bot(token='5881451311:AAEJYKo0ttHU0_Ztv3oGuf-rfFrGgajjtEk') 
#         for stock in signal:
#             adjust_close = round((stock.close + instance.price_option*instance.stock_option - instance.cash)/(1+instance.stock+instance.stock_option),2)
#             stock.cutloss_price = round(stock.cutloss_price*adjust_close/stock.close,2)
#             stock.take_profit_price = round(stock.take_profit_price *adjust_close/stock.close,2)
#             stock.exit_price = round(stock.exit_price*adjust_close/stock.close,2)
#             stock.is_adjust_divident = True
#             stock.close = adjust_close
#             stock.save()
#             bot.send_message(
#                     chat_id='-870288807', 
#                     text=f"Đã điều chỉnh tín hiệu cổ phiếu {stock.ticker}, mua ngày {stock.date} khi có quyền cổ tức phát sinh")    
